...
vcom -cover bfs -work LIB_CONTROLLER Controller_binary.vhd
vcom -cover bfs -work LIB_CONTROLLER Controller_gray.vhd
vcom -cover bfs -work LIB_CONTROLLER Controller_onehot.vhd
